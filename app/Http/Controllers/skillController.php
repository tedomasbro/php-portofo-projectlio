...
class skillController extends Controller
{
    public function index(){
        $skill_url = public_path('scdash/devicon.json');
    ...
    public function update(Request $request){
        if ($request->method() == 'POST') {
            $request->validate(
                ...
                [
                    '_language.required' => 'Please Input Your Skills',
                    '_workflow.required' => 'Please Input Your Workflow'
                ]
            );
            ...
            return redirect()->route('skill.index')->with('success', 'Succes Update Skill Data');
        }
    }
}
